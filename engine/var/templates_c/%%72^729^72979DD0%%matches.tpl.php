<?php /* Smarty version 2.6.17, created on 2018-09-17 16:14:52
         compiled from layout/matches.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'layout/matches.tpl', 22, false),)), $this); ?>
...
" onclick="return confirm('Potwierdź wypisanie się klikając OK. Jeżeli zapiszesz się ponownie zostaniesz umieszcony na końcu listy!')">Wypisz się</a><?php else: ?>| <a class="glink" href="?module=match&action=signin&id=<?php echo $this->_tpl_vars['match']->esmat_id; ?>
&login=<?php echo $_SESSION['admin']['essysus_login']; ?>
">Zapisz się</a><?php endif; ?>
                <?php endif; ?>
                <?php if ($_SESSION['admin']['esurole_id'] == 'ADMINISTRATOR'): ?>
                | <a class="rlink" href="?module=match&action=deletematch&id=<?php echo $this->_tpl_vars['match']->esmat_id; ?>
">Usuń</a>
                <?php endif; ?>
...
<table>
    <tr><td colspan="13" style="padding-left: 40px;">
                <div id="pages">
                        ...
                        <a class="prevnext" href="?module=match&amp;action=showmatches2&amp;from=<?php echo $this->_tpl_vars['escore']['prevfrom']-1; ?>
"><< poprzednia </a> |
                        <?php endif; ?>
...
"><?php echo $this->_tpl_vars['page']['iter']; ?>
                        ...
                        <a class="prevnext" href="?module=match&amp;action=showmatches2&amp;&amp;from=<?php echo $this->_tpl_vars['escore']['nextfrom']-1; ?>
"> następna >> </a>
                        <?php endif; ?>
                </div>
       </td></tr>
