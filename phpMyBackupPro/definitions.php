...
$_PMBP_GLOBAL_CONF="../../engine/config/global_conf.php";       // example: $_PMBP_GLOBAL_CONF="../../files/global_conf.php";
$_PMBP_EXPORT_DIR="../../engine/export/";                // example: $_PMBP_EXPORT_DIR="../../files/export/";
